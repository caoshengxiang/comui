  ...
  <div>
    ...
    <div id="playBox" :class="{'full-screen': isFullScreen}">
      ...
      <div v-if="barShow" class="control-bar">
        ...
        <div class="l">
          <span>
            <i style="transform: scale(0.8)" v-if="!isPlaying" class="icon play-white-32"
               @click="vPlay"></i>
            <i style="transform: scale(0.8)" v-if="isPlaying" class="icon pause-white-32"
               @click="vPause"></i>
          </span>

          <span>
            <i style="transform: scale(0.88)" @click="forwardTime(-forwardTimeSeconds)"
        ...
        <div class="r">
          ...
          <span>
            ...
            <i style="transform: scale(0.8)" v-if="isFullScreen" class="icon exitFull2-white-32"
